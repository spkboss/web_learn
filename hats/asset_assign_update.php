...
<!-- MAIN PAGE WORK -->
<div class="main1">
    <div class=ttl><B>HRI-ASSIGN ASSET UPDATE</B></div>
	
     Update/Edit data of asset ...
    <form name="search" method="post" action="asset_assign_update.php">
    <!-- Search data -->
       <div class="text-search">
          <h5 class="card-header">Search User By name, mobile number & via status</h5>
          <div class="card-body">
      ...
      <th WIDTH="10%">Release Description</th>
      <th WIDTH="5%">Release Date</th>
			<th WIDTH="10%">Update Record</th>
  ...
  <tr>
   <td>
    ...
    <?php 
      ...
      ?>
			<td WIDTH="5%"><strong><font size="2"><center><?php echo $row['srno']; ?></center></font></strong></td>
			<td WIDTH="10%"><strong><font size="2"><center><?php echo $row['an_rec_date']; ?></center></font></strong></td>
			<td WIDTH="10%"><strong><font size="2"><center><?php echo $row['an_name']; ?></center></font></strong></td>
      <td WIDTH="10%"><strong><font size="2"><center><?php echo $row['an_mobile']; ?></center></font></strong></td>
      <td WIDTH="10%"><strong><font size="2"><center><?php echo $row['an_email']; ?></center></font></strong></td>
			<td WIDTH="10%"><strong><font size="2"><center><?php echo $row['an_make']; ?></center></font></strong></td>
			<td WIDTH="5%"><strong><font size="2"><center><?php echo $row['an_type']; ?></center></font></strong></td>
			<td WIDTH="10%"><strong><font size="2"><center><?php echo $row['an_serial']; ?></center></font></strong></td>
			<td WIDTH="5%"><strong><font size="2"><center><?php echo $row['use_status']; ?></center></font></strong></td>		
      <td WIDTH="10%"><strong><font size="2"><center><?php echo $row['an_rel_des']; ?></center></font></strong></td> 
      <td WIDTH="5%"><strong><font size="2"><center><?php echo $row['an_rel_date']; ?></center></font></strong></td> 
      <td WIDTH="10%"><strong> <center><a href="release_asset.php?srno=<?php echo $row["srno"]; ?>" class="atag_btn">Release</a></strong><center></td>
      </tr>
      <?php }  } else { ?>
